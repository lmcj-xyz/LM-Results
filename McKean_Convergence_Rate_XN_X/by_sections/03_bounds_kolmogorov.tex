...
\begin{proof}
    ...
    Plugging
    \zref{eq:norm_bounded_by_rho_norm}
    into
    \zref{eq:u-uN_in_Linfinity_bounded_by_u-uN_in_Calpha1}
   ...
   For
   \zref{eq:graduNu_bounded_by_bNb}
   recall that if
   $f \in \mathcal{C}^{1 + \alpha}$
   then
